...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (store_get($$store_subs ??= {}, "$globalError", globalError)) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="container mx-auto px-4 py-6"><div class="text-red-600 font-bold bg-red-100 p-4 rounded">⚠️ Error: ${escape_html(store_get($$store_subs ??= {}, "$globalError", globalError))}</div></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
      if (!store_get($$store_subs ??= {}, "$GameOver", GameOver)) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div class="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950"><div class="bg-white rounded-3xl shadow-2xl px-12 py-10 w-full max-w-lg"><h1 class="text-3xl font-bold text-center mb-8 text-slate-900">User Access</h1> `);
        {
          $$renderer2.push("<!--[!-->");
          $$renderer2.push(`<button id="start" class="w-full h-12 rounded-xl bg-green-600 hover:bg-green-700 text-white text-base font-semibold shadow-lg hover:shadow-xl transition-all">Enter Simulation</button>`);
        }
        $$renderer2.push(`<!--]--></div></div>`);
      } else {
        $$renderer2.push("<!--[!-->");
        $$renderer2.push(`<div class="container mx-auto px-4 py-6">`);
        if (store_get($$store_subs ??= {}, "$GameOver", GameOver)) {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<div class="max-w-xl mx-auto p-6 bg-white rounded-lg shadow-md text-center space-y-6"><h3 class="text-2xl font-bold text-red-600">Game Over!</h3> <div><h4 class="text-xl font-semibold text-gray-800">Your Stats:</h4> <ul class="list-disc list-inside text-left text-gray-700 mt-2 space-y-1"><li><span class="font-medium">Earnings:</span> $${escape_html(store_get($$store_subs ??= {}, "$earned", earned))}</li> <li><span class="font-medium">Finished Orders:</span> ${escape_html(store_get($$store_subs ??= {}, "$finishedOrders", finishedOrders).length)}</li></ul></div> `);
          {
            $$renderer2.push("<!--[!-->");
          }
          $$renderer2.push(`<!--]--></div>`);
          ...
          $$renderer2.push("<!--[!-->");
          $$renderer2.push(`<header class="sticky top-0 z-50 bg-white/90 backdrop-blur shadow-sm border-b border-slate-200"><div class="mx-auto max-w-5xl px-4 py-3 flex items-center justify-between"><div class="text-sm font-semibold text-red-600">Do not refresh or close the page!</div> `);
          {
            $$renderer2.push("<!--[!-->");
          }
          $$renderer2.push(`<!--]--></div></header> <div class="min-h-screen bg-slate-50 py-6">`);
          if (inSelect) {
            $$renderer2.push("<!--[-->");
            Home($$renderer2);
          } else {

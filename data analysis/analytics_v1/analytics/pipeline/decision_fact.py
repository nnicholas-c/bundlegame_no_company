...
def build_decision_fact(
    ...
    for decision in decisions:
        ...
        row = {
            ...
            "study_protocol_id": str(decision.get("study_protocol_id", "") or ""),
            ...
            "dataset_snapshot_id": str(decision.get("dataset_snapshot_id", "") or ""),
            "legal_action_mask_version": str(decision.get("legal_action_mask_version", "") or ""),
            ...
            "shown_ranked_bundles": json.dumps(decision.get("shown_ranked_bundles", []) or []),
            ...
            "logged_reward": _safe_float(decision.get("logged_reward")),
            "trust_rating": _safe_float(decision.get("trust_rating")),
            "usefulness_rating": _safe_float(decision.get("usefulness_rating")),
            "workload_rating": _safe_float(decision.get("workload_rating")),
